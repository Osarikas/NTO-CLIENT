...
public class MainActivity extends AppCompatActivity {
    ...
    private void getAllUserData(){
        Call<User> call = service.getInfo(sharedPreferences.getString("login", null));
    ...
    public void ScanClick(View v){
        ...
        editor.apply();
        QrScanFragment qrScan = QrScanDestination.INSTANCE.newInstance();
        getSupportFragmentManager().beginTransaction().replace(R.id.qrScan, qrScan).addToBackStack(null).commit();
